-- Phase 3: Two-Table Design Setup (Clean Install)
-- Run this after deleting the existing tables
...
SELECT 'Journeys table structure:' as info;
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_name = 'journeys' 
ORDER BY ordinal_position;

SELECT 'Journey_steps table structure:' as info;
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
