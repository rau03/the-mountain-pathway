  ...
  return (
    <header className="flex items-center justify-between gap-3">
      ...
      <button
        ...
        className="bg-black/10 backdrop-blur-sm border border-brand-slate/20 rounded-full w-11 h-11 flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity flex-shrink-0 overflow-hidden"
