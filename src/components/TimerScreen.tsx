...
export const TimerScreen: React.FC<TimerScreenProps> = ({ step }) => {
  const { silenceTimer, setSilenceTimer, isTimerActive, startTimer, stopTimer } = useStore();
      ...
      >
        <div className="text-center space-y-6">
          ...
          {timeLeft === 0 && (
            ...
            >
              <p className="text-amber-400 font-medium">Time for silence complete</p>
              <p className="text-slate-300 text-sm">When you're ready, continue your journey</p>
            </motion.div>
          )}
        </div>
      </motion.div>
