    ...
    <LegalPageLayout>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside text-brand-navy/85 space-y-2 ml-4">
          ...
          <p className="text-brand-navy/85 leading-relaxed mt-2">
        ...
        <section className="space-y-4">
          ...
          <p className="text-brand-navy/85 leading-relaxed mt-4 font-medium">
