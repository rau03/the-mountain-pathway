...
export default function DataDeletion() {
  return (
    <LegalPageLayout>
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-2 text-brand-navy/85 hover:text-brand-navy transition-colors mb-8"
      >
      ...
      <div className="prose prose-slate max-w-none space-y-8">
        <p className="text-brand-navy/85 italic">Last Updated: December 28, 2025</p>

        <p className="text-brand-navy/85 leading-relaxed text-lg">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-brand-slate flex items-center gap-2">
            <Trash2 className="w-5 h-5 text-brand-navy" />
          ...
          <ol className="list-decimal list-inside text-brand-navy/85 space-y-3 ml-4">
            <li>
          ...
          <p className="text-brand-navy/85 leading-relaxed mt-4">
        ...
        <section className="space-y-4">
          ...
          <ol className="list-decimal list-inside text-brand-navy/85 space-y-2 ml-4">
            <li>
              ...
              <a
                ...
                className="text-brand-navy underline hover:text-brand-navy/85"
              >
        ...
        <div className="text-center pt-8 border-t border-brand-slate/10 mt-8">
          <BuyMeCoffeeLink className="inline-flex items-center gap-2 text-sm text-brand-navy/85 hover:text-brand-navy transition-colors" />
        </div>
      </div>
    </LegalPageLayout>
  );
